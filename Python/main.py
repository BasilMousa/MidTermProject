...
def main():
    ...
    while True:
        ...
        if choice == "1":
            ...
            print(f"Total Selling Price: ${summary['total_selling']}")
            print(f"Total Profit: ${summary['total_profit']}")
            print("Items in inventory:")
            for item in summary['items']:
                print(
                    f"ID: {item['id']}, Type: {item['type']}, Status: {item['status']}, Cost Price: ${item['cost_price']}, Selling Price: ${item['selling_price'] or 'N/A'}")
